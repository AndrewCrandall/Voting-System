/*
Title : Candidate Remove
Summary : Administrator's ability to remove candidates
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(424, 185);
			...
			this->label1->Size = System::Drawing::Size(360, 46);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Remove Candidate";
			// 
			// candidateRemove
			// 
