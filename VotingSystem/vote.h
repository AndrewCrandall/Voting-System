...
#pragma endregion
	...
	//Function to determine if the user has voted, will bring up correct voted candidate
	// if the user has not voted, will display nothing.
	private: System::Void vote_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		//Obtains the number of candidates
		//		Used to dynamically populate interface
